...
## 三、如何使用Markdown
  ...
  当然，本站也提供了实现部分demo的视频--[Markdown Demo](http://localhost:5173/SimpleCodeGuide/basic/tool/markdown.html)。如果你的电脑已经安装好了[Visiual Studio Code](http://localhost:5173/SimpleCodeGuide/basic/tool/markdown.html)此类编辑器，配合食用更佳。
